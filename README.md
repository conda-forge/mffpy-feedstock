...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mffpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11273&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mffpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mffpy` can be installed with:

```
conda install mffpy
```

It is possible to list all of the versions of `mffpy` available on your platform with:
